 ...
 * - anon → (auth) welcome
 * - authed + onboarding NOT completed → /onboarding/track
 ...
 */
export type GateTarget = '/welcome' | '/onboarding/track' | null;
...
export function resolveTabsGate(params: {
  ...
  if (params.onboardingCompleted === false) return '/onboarding/track';
  return null;
}
